...
func Routers() *gin.Engine {
	...
	{
		hrmsRouter := router.RouterGroupApp.Hrms
		hrmsRouter.InitHrEmployeeRouter(PrivateGroup)
	}
	{
		msysmoneyRouter := router.RouterGroupApp.Msysmoney
		msysmoneyRouter.InitMsYsXm24yRouter(PrivateGroup)
	}
	{
