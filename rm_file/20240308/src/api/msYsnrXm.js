...
// @Param data body model.MsYsnrXm true "创建msYsnrXm表"
...
// @accept application/json
// @Produce application/json
// @Param data body model.MsYsnrXm true "删除msYsnrXm表"
...
// @accept application/json
// @Produce application/json
// @Param data body request.IdsReq true "批量删除msYsnrXm表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"删除成功"}"
// @Router /msYsnrXm/deleteMsYsnrXm [delete]
...
// @accept application/json
// @Produce application/json
// @Param data body model.MsYsnrXm true "更新msYsnrXm表"
...
// @accept application/json
// @Produce application/json
// @Param data query model.MsYsnrXm true "用id查询msYsnrXm表"
...
// @accept application/json
// @Produce application/json
// @Param data query request.PageInfo true "分页获取msYsnrXm表列表"
