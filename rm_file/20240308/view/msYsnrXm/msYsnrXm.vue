<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="department字段" prop="department" width="120" />
        <el-table-column align="left" label="nrType字段" prop="nrType" width="120" />
        <el-table-column align="left" label="projectCode字段" prop="projectCode" width="120" />
        <el-table-column align="left" label="projectName字段" prop="projectName" width="120" />
        <el-table-column align="left" label="customerGroup字段" prop="customerGroup" width="120" />
        <el-table-column align="left" label="customerName字段" prop="customerName" width="120" />
        <el-table-column align="left" label="nrTotal字段" prop="nrTotal" width="120" />
        <el-table-column align="left" label="month1字段" prop="month1" width="120" />
        <el-table-column align="left" label="month2字段" prop="month2" width="120" />
        <el-table-column align="left" label="month3字段" prop="month3" width="120" />
        <el-table-column align="left" label="month4字段" prop="month4" width="120" />
        <el-table-column align="left" label="month5字段" prop="month5" width="120" />
        <el-table-column align="left" label="month6字段" prop="month6" width="120" />
        <el-table-column align="left" label="month7字段" prop="month7" width="120" />
        <el-table-column align="left" label="month8字段" prop="month8" width="120" />
        <el-table-column align="left" label="month9字段" prop="month9" width="120" />
        <el-table-column align="left" label="month10字段" prop="month10" width="120" />
        <el-table-column align="left" label="month11字段" prop="month11" width="120" />
        <el-table-column align="left" label="month12字段" prop="month12" width="120" />
