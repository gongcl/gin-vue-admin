<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="项目名称" prop="xmmc" width="120" />
        <el-table-column align="left" label="项目金额" prop="xmje" width="120" />
         <el-table-column align="left" label="项目开始日期" width="180">
            <template #default="scope">{{ formatDate(scope.row.kssj) }}</template>
         </el-table-column>
         <el-table-column align="left" label="项目结束日期" width="180">
        ...
        <el-table-column align="left" label="项目状态" prop="xmzt" width="120" />
        <el-table-column align="left" label="所在城市" prop="xmcs" width="120" />
        <el-table-column align="left" label="在岸离岸" prop="site" width="120" />
        <el-table-column align="left" label="结算模式" prop="jsms" width="120" />
        <el-table-column align="left" label="预算收入" prop="srys" width="120" />
        <el-table-column align="left" label="预算毛利" prop="mlys" width="120" />
        <el-table-column align="left" label="预算毛利率" prop="mlyys" width="120" />
        <el-table-column align="left" label="滚动收入" prop="gdsr" width="120" />
        <el-table-column align="left" label="滚动毛利" prop="gdml" width="120" />
        <el-table-column align="left" label="滚动毛利率" prop="gdmll" width="120" />
        ...
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
            ...
            <el-button type="primary" link icon="edit" class="table-button" @click="updateMsXmListFunc(scope.row)">变更</el-button>
