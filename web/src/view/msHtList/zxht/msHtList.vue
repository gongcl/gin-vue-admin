    ...
    <div class="gva-search-box">
      <el-form ref="elSearchFormRef" :inline="true" :model="searchInfo" class="demo-form-inline" :rules="searchRule" @keyup.enter="onSubmit">
        ...
        <el-form-item label="是否B类" prop="sfbl">
         <el-input v-model="searchInfo.sfbl" placeholder="搜索条件" />

        </el-form-item>
        <el-form-item label="是否E类" prop="sfel">
         <el-input v-model="searchInfo.sfel" placeholder="搜索条件" />

        </el-form-item>
        <el-form-item label="合同金额" prop="xmje">
            
             <el-input v-model.number="searchInfo.xmje" placeholder="搜索条件" />
